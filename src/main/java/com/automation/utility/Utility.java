...
public class Utility extends ManageDriver {
    ...
    public void clearTextFromField(WebElement webElement) {
...
//*************************** Select Class Methods ***************************************//
    ...
    public void setRadioElement(By by) {
        ...
        public void setRadioElement(WebElement webElement) {
        boolean selectState = webElement.isSelected();
        if (selectState == false) {
            webElement.click();
        }
    }
...
// Random email generate
    public void randomEmail(WebElement webElement){
        ...
        webElement.sendKeys("Dimple"+ randomInt +"@gmail.com");
    }
